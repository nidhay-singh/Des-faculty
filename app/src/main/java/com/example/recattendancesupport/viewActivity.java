...
public class viewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        display = findViewById(R.id.editText2);
        editText = findViewById(R.id.editText2);
        btnWriteSDFile = findViewById(R.id.button55);
        ...
        btnWriteSDFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    filename = new File(path + "/folder/subfolder/attendance_"+timeStamp+".xlsx");
                    ...
                    myOutWriter.close();
                    fOut.close();
                    Toast.makeText(getBaseContext(), "Attendance saved.", Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
